    ...
    - generic [active] [ref=f26e1]:
      - generic:
        - region "Thông điệp bánh mì nướng":
          - heading "Tổng cộng 0 thông báo" [level=2] [ref=f26e3]
          - alert
      - region [ref=f26e4]
      - generic [ref=f26e5]:
        - generic [ref=f26e7]:
          - button "Bỏ qua để tìm kiếm" [ref=f26e8] [cursor=pointer]:
            - generic [ref=f26e9]: Bỏ qua để tìm kiếm
          - button "Chuyển đến nội dung chính" [ref=f26e10] [cursor=pointer]:
            - generic [ref=f26e11]: Chuyển đến nội dung chính
          - button "Phím tắt bàn phím" [ref=f26e12] [cursor=pointer]:
            - generic [ref=f26e13]: Phím tắt bàn phím
          - button "Đóng menu chuyển đến" [ref=f26e14] [cursor=pointer]:
            - img [ref=f26e15]
            - generic [ref=f26e17]: Đóng menu chuyển đến
        - banner "Điều hướng toàn cầu" [ref=f26e18]:
          - generic [ref=f26e19]:
            - link "LinkedIn" [ref=f26e20] [cursor=pointer]:
              - /url: https://www.linkedin.com/feed/?nis=true
              - img "LinkedIn" [ref=f26e23]:
                - img [ref=f26e24]
            - generic [ref=f26e28]:
              - combobox "Tìm kiếm" [ref=f26e29]
              - generic:
                - img
            - navigation "Điều hướng chính" [ref=f26e30]:
              - list [ref=f26e31]:
                - listitem [ref=f26e32]:
                  - link "cập nhật bảng tin thông báo mới Trang chủ" [ref=f26e33] [cursor=pointer]:
                    - /url: https://www.linkedin.com/feed/
                    - generic [ref=f26e34]:
                      - generic [ref=f26e37]: cập nhật bảng tin thông báo mới
                      - img [ref=f26e41]
                    - generic "Trang chủ" [ref=f26e43]
                - listitem [ref=f26e44]:
                  - link "Mạng lưới" [ref=f26e45] [cursor=pointer]:
                    - /url: https://www.linkedin.com/mynetwork/?
                    - img [ref=f26e49]
                    - generic "Mạng lưới" [ref=f26e51]
                - listitem [ref=f26e52]:
                  - link "Việc làm" [ref=f26e53] [cursor=pointer]:
                    - /url: https://www.linkedin.com/jobs/?
                    - img [ref=f26e57]
                    - generic "Việc làm" [ref=f26e59]
                - listitem [ref=f26e60]:
                  - link "Nhắn tin" [ref=f26e61] [cursor=pointer]:
                    - /url: https://www.linkedin.com/messaging/?
                    - img [ref=f26e65]
                    - generic "Nhắn tin" [ref=f26e67]
                - listitem [ref=f26e68]:
                  - link "Thông báo" [ref=f26e69] [cursor=pointer]:
                    - /url: https://www.linkedin.com/notifications/?
                    - img [ref=f26e73]
                    - generic "Thông báo" [ref=f26e75]
                - listitem [ref=f26e76]:
                  - button "Dung Tran Tôi" [ref=f26e78] [cursor=pointer]:
                    - img "Dung Tran" [ref=f26e79]
                    - generic [ref=f26e80]:
                      - text: Tôi
                      - img [ref=f26e81]
                - listitem [ref=f26e83]:
                  - button "Dành cho doanh nghiệp" [ref=f26e85] [cursor=pointer]:
                    - img [ref=f26e89]
                    - generic "Dành cho doanh nghiệp" [ref=f26e91]:
                      - text: Dành cho doanh nghiệp
                      - img [ref=f26e92]
                - listitem [ref=f26e94]:
                  - link "Dùng thử gói Cao cấp cho 0 ₫" [ref=f26e96] [cursor=pointer]:
                    - /url: javascript:void(0)
                    - generic [ref=f26e98]: Dùng thử gói Cao cấp cho 0 ₫
```